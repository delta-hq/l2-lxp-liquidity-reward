export default [
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint256", name: "lTokenBalance", type: "uint256" },
  ...
  },
  {
    ...
    name: "liquidateBorrow",
    outputs: [
      { internalType: "uint256", name: "seizeLAmount", type: "uint256" },
      { internalType: "uint256", name: "rebateLAmount", type: "uint256" },
      { internalType: "uint256", name: "liquidatorLAmount", type: "uint256" },
    ],
  ...
  },
  {
    ...
    name: "rateModel",
    outputs: [
      { internalType: "contract IRateModel", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "_rateModel", type: "address" }],
    name: "setRateModel",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address", name: "_rebateDistributor", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_reserveFactor", type: "uint256" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "_underlying", type: "address" }],
    name: "setUnderlying",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
