export default [
  ...
  },
  {
    ...
    name: "labDistributor",
    outputs: [
      { internalType: "contract ILABDistributor", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newCloseFactor", type: "uint256" },
    ],
    name: "setCloseFactor",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_labDistributor", type: "address" },
    ],
