...
const ZypherRestaking: Record<string, {
  URL: string;
}> = {
  LINEA_MAINNET: {
    URL: '',
  ...
  LINEA_SEPOLIA: {
    URL: 'https://linea-sepolia-graph.zypher.game/subgraphs/name/zypher/restaking',
  },
}
...
const getAllDepositBalances = async (
  ...
  const responseJson = await post(ZypherRestaking.LINEA_SEPOLIA.URL, {
