...
const LINEA_RSETH_SUBGRAPH =
  "https://api.thegraph.com/subgraphs/id/QmYU2LVKDDQTztMYVHf6tSrPYGx9TdNkad4jYTCL22XtfE";
export const LINEA_RSETH_ADDR = "0x4186BFC76E2E237523CBC30FD220FE055156b41F";
export const LINEA_RSETH = "rsETH";
interface IDwise {
  id: string;
}
